# Lab name value set - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Lab name value set**

## ValueSet: Lab name value set 

| | |
| :--- | :--- |
| *Official URL*:http://example.org/ValueSet/LabNameVS | *Version*:0.1.0 |
| Active as of 2026-06-03 | *Computable Name*:LabNameVS |
